                  ...
                  <table class="table table-hover">
                    ...
                    <?php foreach ($data_user as $m): ?>
                      <tr>
                        ...
                        <td><?php echo $m['nama_role']?></td>
                        <td><?php echo $m['is_active']?></td>
                        <td>
                        <a href="http://" class="badge badge-warning">Change Pass</a>
                        <a href="http://" class="badge badge-success">Edit</a>
                        <a href="<?php echo base_url('admin/userManagementDelete/').$m['id']; ?>" class="badge badge-danger">Delete</a>
                        </td>
                      </tr>
                    <?php $i++; ?>
                    <?php endforeach; ?>
