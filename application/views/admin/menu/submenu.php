                  ...
                  <table class="table table-hover">
                    ...
                    <?php foreach ($data_menu as $m): ?>
                      <tr>
                        ...
                        <a href="<?php echo base_url('menu/subMenuDelete/').$m['id']; ?>" class="badge badge-danger" >Delete</a>
                        </td>
                      </tr>
                    <?php $i++; ?>
                    <?php endforeach; ?>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="form-group">
            <select class="custom-select custom-select" id='sub_menu_id' name='sub_menu_id'>
            <option selected>-- Pilih Parent</option>
            <?php foreach ($arr_parent as $value) : ?>
        ...
        <div class="form-group">
          <input type="text" class="form-control" id="urutan" name="urutan" placeholder="Urutan Sub Menu">
        </div>
        <div class="form-group">
